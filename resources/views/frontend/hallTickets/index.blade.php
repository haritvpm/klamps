                                    ...
                                    <tr data-entry-id="{{ $hallTicket->id }}">
                                        ...
                                        <td>
                                            @can('hall_ticket_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.hall-tickets.show', $hallTicket->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan
                                            ...
                                            @can('hall_ticket_delete')
                                                <form action="{{ route('frontend.hall-tickets.destroy', $hallTicket->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('hall_ticket_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.hall-tickets.massDestroy') }}",
